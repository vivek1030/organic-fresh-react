    ...
    <header className="sticky top-0 z-[100] w-full border-b border-stone-100 bg-white md:bg-white/90 md:backdrop-blur-xl shadow-sm md:shadow-none">
      <div className="container mx-auto flex h-16 md:h-20 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-1 md:gap-6">
          {/* Search Bar - Desktop */}
          <div
            className="relative hidden xl:block w-72 xl:w-96"
            ref={searchRef}
          >
                ...
                <>
                  ...
                  <div className="fixed md:absolute top-0 right-0 md:top-full h-full md:h-auto w-full md:w-[400px] origin-top-right rounded-none md:rounded-[2.5rem] bg-white p-6 md:p-8 shadow-2xl border-l md:border border-stone-100 animate-in slide-in-from-right md:slide-in-from-top-4 md:zoom-in-95 duration-300 z-[60]">
                    <div className="flex items-center justify-between mb-8">
                      ...
                      <button
                        onClick={() => setIsCartOpen(false)}
                        className="h-10 w-10 flex items-center justify-center rounded-xl bg-stone-50 text-stone-400 hover:text-stone-900 transition-colors"
                      >
                        <X size={20} />
                      </button>
                    </div>
                      ...
                      <div className="flex flex-col h-[calc(100%-100px)] md:h-auto">
                        <div className="flex-1 overflow-y-auto space-y-6 mb-8 pr-2 scrollbar-thin">
                          {items.map((item) => (
                            <div key={item.id} className="flex gap-4 group">
                              ...
                              <div className="flex-1 min-w-0">
                                <h4 className="text-sm md:text-base font-black text-stone-900 truncate">
                                  {item.name}
                                </h4>
                        ...
                        <div className="border-t border-stone-100 pt-6 md:pt-8 space-y-4 bg-white mt-auto">
                          <div className="flex items-center justify-between">
                            <span className="text-stone-400 font-bold uppercase tracking-widest text-[10px] md:text-xs">
                              Total Amount
                            </span>
            ...
            <div className="hidden md:flex items-center">
              {isAuthenticated ? (
                <div className="relative" ref={dropdownRef}>
                  ...
                  {isProfileOpen && (
                    <div className="absolute right-0 mt-4 w-64 origin-top-right rounded-[2rem] bg-white p-4 shadow-2xl border border-stone-100 animate-in fade-in zoom-in-95 duration-300">
                      ...
                      <Link
                        to="/profile"
                        className="flex items-center gap-3 rounded-xl px-4 py-3 text-sm font-bold text-stone-600 hover:bg-stone-50 hover:text-green-600 transition-all"
                        onClick={closeAllMenus}
                      >
                        <User size={18} />
                        My Profile
                ...
                <Link to="/signin" className="pl-4 border-l border-stone-100">
                  <Button
                    size="sm"
                    className="px-8 py-6 font-black text-xs uppercase tracking-widest"
                  >
                    Sign In
                  </Button>
                </Link>
        ...
        <div className="fixed inset-0 z-[100] bg-white animate-in slide-in-from-top duration-300 flex flex-col">
          <div className="flex items-center gap-3 p-6 border-b border-stone-100 shrink-0">
            <button
              ...
              className="h-12 w-12 flex items-center justify-center rounded-2xl bg-stone-50 text-stone-500"
            >
              <ArrowLeft size={24} />
            </button>
            ...
            {searchResults.length > 0 ? (
              <div className="p-6">
                <div className="flex items-center justify-between mb-6 px-2">
                  <span className="text-xs font-black text-stone-400 uppercase tracking-[0.2em]">
                    Harvest Results ({searchResults.length})
                  </span>
                </div>
                  ...
                  {searchResults.map((result) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="font-black text-stone-900 truncate text-xl">
                          {result.name}
                        </p>
                        <div className="flex items-center gap-3 mt-3">
                          ...
                          {result.discount && (
                            <span className="text-xs font-black text-red-500 bg-red-50 px-2 py-1 rounded-lg">
              ...
              <div className="p-16 text-center">
                ...
                <p className="text-stone-900 text-2xl font-black">
                  No matches found
                </p>
              ...
              <div className="p-8">
                <h3 className="text-xs font-black text-stone-400 uppercase tracking-[0.2em] mb-6 px-2">
                  Popular Searches
                </h3>
        ...
        <div className="md:hidden fixed inset-0 top-20 z-40 bg-white animate-in slide-in-from-top duration-300 overflow-y-auto">
          <div className="p-6 space-y-10">
            <nav className="flex flex-col gap-2">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-stone-400 px-4 mb-4">
                Main Menu
              </p>
              {navLinks.map((link) => (
                <Link
            ...
            <div className="pt-10 border-t border-stone-100">
              <p className="text-[10px] font-black uppercase tracking-[0.2em] text-stone-400 px-4 mb-6">
                User Account
              </p>
              {isAuthenticated ? (
                ...
                >
                  <Button className="w-full py-8 text-xl font-black shadow-2xl shadow-green-100 rounded-3xl">
                    Sign In to Bag
                  </Button>
                </Link>
              )}
