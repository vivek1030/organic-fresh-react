          ...
          <div className="grid gap-12 lg:grid-cols-2 lg:gap-8 items-center">
            <div className="space-y-10 text-center lg:text-left">
              ...
              <h1 className="text-5xl font-black tracking-tighter text-stone-900 sm:text-7xl lg:text-8xl leading-[0.9]">
                ...
                Deeply{' '}
                <span className="italic font-serif text-stone-400">Fresh</span>.
              </h1>
              <p className="max-w-xl mx-auto lg:mx-0 text-lg md:text-xl text-stone-600 font-medium leading-relaxed">
                ...
                pesticide-free produce delivered straight from local sustainable
                farms.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                <Link to="/shop">
                  <Button
                    size="lg"
                    className="px-10 py-8 text-lg shadow-2xl shadow-green-200"
                  >
                    Start Shopping
                  </Button>
                </Link>
                <Button
                  size="lg"
                  variant="outline"
                  className="px-10 py-8 text-lg bg-white"
                >
                  Our Story
                </Button>
              </div>
            ...
            {categories.slice(0, 8).map((cat, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute -bottom-20 -right-10 w-64 h-64 rounded-full opacity-20 blur-2xl group-hover:opacity-40 transition-opacity duration-700 ${colorClass.split(' ')[1].replace('text', 'bg')}`}
                  ></div>
                </Link>
              );
            })}
            ...
            <div className="group">
              <div className="mb-8 flex h-20 w-20 items-center justify-center rounded-[2rem] bg-white/5 border border-white/10 text-green-500 transition-all group-hover:bg-green-600 group-hover:text-white group-hover:rotate-12">
                <svg
                  ...
                  strokeLinejoin="round"
                >
                  <path d="M6.38 18.38a3.5 3.5 0 0 0 5.24 0l6-6A3.5 3.5 0 1 0 12.66 7.42l-1 1-1-1A3.5 3.5 0 1 0 5.38 12.62Z" />
                  <path d="M12 2v20" />
                </svg>
              </div>
              ...
              <p className="text-stone-400 font-medium leading-relaxed">
                Zero pesticides. Zero GMOs. Just pure, honest produce grown the
                way nature intended for your wellness.
              </p>
            </div>
            <div className="group">
              <div className="mb-8 flex h-20 w-20 items-center justify-center rounded-[2rem] bg-white/5 border border-white/10 text-green-500 transition-all group-hover:bg-green-600 group-hover:text-white group-hover:rotate-12">
              ...
              <p className="text-stone-400 font-medium leading-relaxed">
                Every item is rigorously tested and certified by international
                standards to ensure the highest organic quality.
              </p>
            </div>
            <div className="group">
              <div className="mb-8 flex h-20 w-20 items-center justify-center rounded-[2rem] bg-white/5 border border-white/10 text-green-500 transition-all group-hover:bg-green-600 group-hover:text-white group-hover:rotate-12">
              ...
              <h3 className="mb-4 text-2xl font-black italic">
                Next Day Farm-to-Door.
              </h3>
              <p className="text-stone-400 font-medium leading-relaxed">
                We harvest at dawn and deliver by dusk. Experience freshness
                that is literally unmatched in the city.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="mb-16 flex flex-col md:flex-row items-end justify-between gap-8">
            <div className="max-w-2xl">
              ...
              <p className="text-stone-500 font-medium text-lg">
                Hand-selected premium organic produce that our customers are
                currently loving. Grab them while they are in season!
              </p>
            </div>
            <Link to="/shop">
              <Button
                variant="outline"
                className="px-8 py-6 rounded-2xl border-stone-200 hover:bg-stone-900 hover:text-white transition-all font-black text-xs uppercase tracking-widest"
              >
            ...
            <div className="relative z-10 w-full p-8 md:p-16 grid lg:grid-cols-2 gap-12 items-center text-white">
              <div className="space-y-6">
                ...
                <h2 className="text-4xl md:text-6xl font-black leading-tight">
                  ...
                  <span className="italic font-serif text-yellow-300 underline underline-offset-8">
                    First Subscription
                  </span>
                </h2>
                <p className="text-lg text-green-50 font-medium max-w-md">
                  Join our weekly harvest club and get the freshest produce
                  delivered to your doorstep every Monday with exclusive
                  ...
                  <div className="text-center space-y-2">
                    ...
                    <div className="pt-6 grid grid-cols-3 gap-4 border-t border-white/10 mt-6">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] uppercase opacity-60">Mins</p>
                      </div>
                      <div>
                        <p className="text-xl font-bold">08</p>
                        <p className="text-[10px] uppercase opacity-60">Secs</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <section className="py-24 bg-[#fbfbf9]">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-16 space-y-4">
            <span className="text-xs font-black text-green-600 uppercase tracking-[0.3em] block">
              Social Proof
            </span>
            <h2 className="text-4xl md:text-6xl font-black text-stone-900">
              Loved by{' '}
            ...
            {[
              {
                name: 'Sarah Johnson',
                role: 'Nutritionist',
                text: "The quality of produce here is consistently higher than any supermarket I've visited. The freshness is truly remarkable.",
                rating: 5,
              },
              {
                name: 'Mark Wilson',
                role: 'Chef',
                text: "As a chef, I'm very picky about my ingredients. Organic Ecommerce has become my go-to for seasonal specialty vegetables.",
                rating: 5,
              },
              {
                name: 'Elena Rodriguez',
                role: 'Mother of 2',
                text: "Knowing exactly where my family's food comes from gives me such peace of mind. Plus, the kids love the sweet strawberries!",
                rating: 5,
              },
            ].map((review, i) => (
              <div
                key={i}
                className="bg-white p-10 rounded-[2.5rem] border border-stone-100 shadow-sm hover:shadow-xl transition-all"
              >
                ...
                <p className="text-stone-600 font-medium text-lg leading-relaxed mb-8 italic">
                  "{review.text}"
                </p>
                <div className="flex items-center gap-4">
          ...
          <div className="rounded-[4rem] bg-stone-900 px-8 py-20 text-center text-white relative overflow-hidden">
            ...
            <div className="relative z-10 max-w-3xl mx-auto space-y-10">
              <h2 className="text-5xl md:text-7xl font-black leading-[0.9]">
                Ready to <span className="text-green-500">Transform</span> Your
                Kitchen?
              </h2>
              <p className="text-xl text-stone-400 font-medium">
                Join our newsletter today for expert nutrition tips, seasonal
                recipes, and a 20% discount on your first organic box.
              </p>
