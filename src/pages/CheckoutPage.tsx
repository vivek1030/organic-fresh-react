    ...
    return (
      <div className="container mx-auto px-4 py-32 text-center">
        ...
        <p className="text-stone-600 mb-8">
          Add some fresh products before checking out.
        </p>
        <Link to="/shop">
  ...
  return (
    <div className="bg-stone-50 min-h-screen pb-20">
      ...
      <div className="container mx-auto px-4 py-8 lg:py-12">
        <h1 className="text-3xl md:text-4xl font-extrabold text-stone-900 mb-8">
          Checkout
        </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-10 pr-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-green-500 outline-none transition-all"
                      />
                    </div>
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2 md:col-span-2">
                    ...
                    <div className="relative">
                      ...
                      <textarea
                        required
                        rows={3}
                        placeholder="123 Organic Lane, Fresh City, 90210"
                        className="w-full pl-10 pr-4 py-3 rounded-xl border border-stone-200 focus:ring-2 focus:ring-green-500 outline-none transition-all resize-none"
                      ></textarea>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xl border border-stone-100 sticky top-24">
              <h2 className="text-xl font-bold text-stone-900 mb-6 pb-4 border-b border-stone-50">
                Order Summary
              </h2>
