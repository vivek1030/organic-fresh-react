        ...
        <div className="container mx-auto px-4 md:px-6 relative z-10">
          <div className="max-w-2xl">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-[0.8] mb-6">
              The{' '}
              <span className="text-green-500 italic font-serif">Organic</span>
              <br />
              Marketplace
            </h1>
            <p className="text-lg text-stone-300 font-medium max-w-md leading-relaxed">
              Discover over 100+ premium organic products sourced directly from
            ...
            <div className="sticky top-28 space-y-8">
              ...
              <div className="rounded-[2.5rem] bg-stone-900 p-8 text-white relative overflow-hidden group">
                <div className="relative z-10">
                  <span className="text-[10px] font-black uppercase tracking-widest text-green-500 mb-2 block">
                    Weekly Special
                  </span>
                  ...
                  <p className="text-xs text-stone-400 font-bold mb-6 italic">
                    Save 20% this week only on all Mexican imports.
                  </p>
                  <Button className="w-full bg-green-600 hover:bg-green-500 text-white font-black py-4 rounded-xl text-xs">
                    Shop Deal
                  </Button>
                </div>
          ...
          <div className="flex-1">
            ...
            {!loadingMore && displayedProducts.length < allProducts.length && (
              <div className="mt-20 text-center">
                ...
                <p className="text-sm font-bold text-stone-400 mb-6 uppercase tracking-widest">
                  You've seen {displayedProducts.length} products
                </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-[2rem] hover:bg-stone-50 transition-colors">
              <div className="h-16 w-16 rounded-3xl bg-green-50 text-green-600 flex items-center justify-center mb-6">
                ...
                >
                  ...
                  <path d="M8.58 16.11a5 5 0 0 1 6.84 0" />
            ...
            <div className="flex flex-col items-center text-center p-6 rounded-[2rem] hover:bg-stone-50 transition-colors">
              <div className="h-16 w-16 rounded-3xl bg-green-50 text-green-600 flex items-center justify-center mb-6">
                ...
                >
                  <path d="M12 22v-9" />
                  <path d="M5 8.9V5a3 3 0 0 1 6 0v3.9" />
                  <path d="M13 8.9V5a3 3 0 0 1 6 0v3.9" />
                  <path d="M3 13h18l-2 9H5l-2-9Z" />
                </svg>
              </div>
              <h4 className="text-lg font-black text-stone-900 mb-2">
                Farm Direct
